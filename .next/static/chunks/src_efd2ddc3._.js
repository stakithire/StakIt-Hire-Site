...
function useAdmin() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useAdmin.useEffect": ()=>{
            // If the main user object is still loading, we are also still checking admin status.
            if (isUserLoading) {
            ...
            // When the user object is available, force a token refresh to get the latest custom claims.
            user.getIdTokenResult(true).then({
                "useAdmin.useEffect": (idTokenResult)=>{
                    // Check for the admin claim on the token.
                    const isAdminClaim = !!idTokenResult.claims.admin;
                    setIsAdmin(isAdminClaim);
                }
            }["useAdmin.useEffect"]).catch({
                "useAdmin.useEffect": (error)=>{
                    console.error('Error fetching user token for admin check:', error);
                    setIsAdmin(false);
                }
            }["useAdmin.useEffect"]).finally({
                "useAdmin.useEffect": ()=>{
...
_s(useAdmin, "VJzo9cDJRw5GU6WLRQr/L0AZwNQ=", false, function() {
    return [
...
//# sourceMappingURL=src_efd2ddc3._.js.map