    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useAdmin.useEffect": ()=>{
            const checkAdminStatus = {
                "useAdmin.useEffect.checkAdminStatus": async ()=>{
                    if (isUserLoading) {
                        // Still waiting for user auth state to resolve
                        return;
                    }
                    if (!user) {
                    ...
                    // User object is available, force a token refresh to get the latest claims.
                    setIsCheckingAdmin(true);
                    try {
                        // Passing `true` to getIdTokenResult forces a refresh from the server.
            ...
            }["useAdmin.useEffect.checkAdminStatus"];
            checkAdminStatus();
        }
    }["useAdmin.useEffect"], [
        user,
        isUserLoading
    ]); // Rerun whenever user or loading state changes
    return {
        isAdmin,
        isCheckingAdmin
    };
...
function NavContent() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
        ...
        children: [
            navItems.map((item)=>{
                if (item.admin && !isAdmin && !isCheckingAdmin) {
                    return null;
                }
...
_s(NavContent, "iLQNMjkxVydnbPwn41eaY8fUSwI=", false, function() {
    return [
...
_s1(MobileNav, "h/bB6LFwe3WWfT2LBfdWn0p85Q4=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$admin$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAdmin"]
    ];
...
_s(AppHeader, "OE+4lfjpc6uzN3bxIhRZI3gTdxg=", false, function() {
    return [
...
//# sourceMappingURL=src_bd998160._.js.map