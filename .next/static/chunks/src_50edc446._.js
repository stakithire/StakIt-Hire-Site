...
function useAdmin() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useAdmin.useEffect": ()=>{
            // Don't do anything until the user state is resolved
            if (isUserLoading) {
                return;
            }
            ...
            // User object is available, now check for the claim.
            // We force a refresh of the token to get the latest claims.
            const checkAdminStatus = {
                "useAdmin.useEffect.checkAdminStatus": async ()=>{
                    try {
                        const idTokenResult = await user.getIdTokenResult(true);
                        // The admin claim is on the token result, not the user object itself
...
_s(AppFooter, "bK+tR5kC32IjO2w4yrvHhWYVaYg=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$admin$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAdmin"]
    ];
});
...
//# sourceMappingURL=src_50edc446._.js.map