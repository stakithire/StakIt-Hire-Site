    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AppHeader.useEffect": ()=>{
            ...
            if (user) {
                ...
                user.getIdTokenResult(true).then({
                    "AppHeader.useEffect": (idTokenResult)=>{
                        const isAdminClaim = !!idTokenResult.claims.admin;
                        setIsAdmin(isAdminClaim);
                        // A bit of a hack to make the user object aware of the admin status for other components
...
_s(AppHeader, "MVx0NrYfHouWQFQebn+rOVGud/I=", false, function() {
    return [
...
//# sourceMappingURL=src_edc977c2._.js.map