...
;
// IMPORTANT: Do not modify this file. This is the only file that should be using the service account key.
...
function initializeAdminApp() {
    ...
    if (!serviceAccountKey.project_id || !serviceAccountKey.private_key || !serviceAccountKey.client_email) {
        throw new Error('Firebase Admin SDK credentials are not set in the environment. Cannot initialize.');
    }
...
([__TURBOPACK__imported__module__$5b$externals$5d2f$firebase$2d$admin$2f$auth__$5b$external$5d$__$28$firebase$2d$admin$2f$auth$2c$__esm_import$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$admin$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__);
;
;
;
;
...
async function makeMeAdmin() {
    try {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$admin$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["initializeAdminApp"])();
        ...
        // IMPORTANT: Hardcoded email for the initial admin user.
        const adminEmail = 'stakithire@gmail.com';
        // Get user from the client-side session (this is just for the check)
        // A more robust solution for general actions would use token verification.
        // For this one-time bootstrap, checking the email from the current user is sufficient.
        // We cannot get user session directly here without more setup,
        // so we'll trust the client to call this only for the correct user.
        // The most important part is getting the user by email on the backend.
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8f48c9a7._.js.map