...
function ItemCheckboxList({ form, title, items }) {
    const formatPrice = (item)=>{
        let priceString = '';
        if ('price' in item && item.price) {
            priceString = item.price;
            if ('unit' in item && item.unit) {
                priceString += `/${item.unit}`;
            }
        } else {
            const hirePrice = 'hirePrice' in item ? item.hirePrice : null;
            const purchasePrice = 'purchasePrice' in item ? item.purchasePrice : null;
            if (hirePrice && purchasePrice) {
                priceString = `Hire: ${hirePrice} / Buy: ${purchasePrice}`;
            } else if (hirePrice) {
                priceString = `Hire: ${hirePrice}`;
            } else if (purchasePrice) {
                priceString = `Buy: ${purchasePrice}`;
            }
        }
...
function QuoteForm() {
    ...
    async function onSubmit(values) {
        ...
        try {
            const selectedItems = values.items.map((id)=>allItems.find((item)=>item.id === id)?.name || 'Unknown Item').join(', ');
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$form$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["FormDescription"], {
                                                        children: "Choose the items you'd like to include in your quote."
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/components/quote-form.tsx",
                                                        lineNumber: 315,
                                                        columnNumber: 29
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(ItemCheckboxList, {
                                                                form: form,
                                                                title: "",
...
//# sourceMappingURL=src_3a2138be._.js.map