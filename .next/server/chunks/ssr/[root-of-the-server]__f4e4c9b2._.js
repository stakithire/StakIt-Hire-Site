...
"[project]/src/app/data:98ed46 [app-ssr] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$data$3a$98ed46__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/data:98ed46 [app-ssr] (ecmascript) <text/javascript>");
'use client';
;
;
;
        ...
        if (user && user.email === 'stakithire@gmail.com') {
            const checkAndSetAdmin = async ()=>{
                ...
                if (!idTokenResult.claims.admin) {
                    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$data$3a$98ed46__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["setAdminClaimForUser"])(user.uid, user.email);
                    if (result.claimSet) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f4e4c9b2._.js.map