...
function initializeAdminApp() {
    const appName = 'firebase-admin-app-[StakIt Hire]';
    ...
    if (!serviceAccountKey.project_id || !serviceAccountKey.private_key || !serviceAccountKey.client_email) {
        throw new Error('Firebase Admin SDK credentials are not set. Cannot initialize.');
    }
    // Initialize a new app with a unique name.
    return (0, __TURBOPACK__imported__module__$5b$externals$5d2f$firebase$2d$admin$2f$app__$5b$external$5d$__$28$firebase$2d$admin$2f$app$2c$__esm_import$29$__["initializeApp"])({
...
var { g: global, __dirname, a: __turbopack_async_module__ } = __turbopack_context__;
__turbopack_async_module__(async (__turbopack_handle_async_dependencies__, __turbopack_async_result__) => { try {
/* __next_internal_action_entry_do_not_use__ [{"40346d2d5ee0a4a0d5f6e3e0e1a633596edee5c7cb":"getAdminQuoteRequests","608516e2307f033f1b02ca6ef91ff045c0ffa6a34a":"updateQuoteStatus"},"",""] */ __turbopack_context__.s({
...
([__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$admin$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$externals$5d2f$firebase$2d$admin$2f$firestore__$5b$external$5d$__$28$firebase$2d$admin$2f$firestore$2c$__esm_import$29$__, __TURBOPACK__imported__module__$5b$externals$5d2f$firebase$2d$admin$2f$auth__$5b$external$5d$__$28$firebase$2d$admin$2f$auth$2c$__esm_import$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__);
;
;
;
;
...
async function verifyAdmin(idToken) {
    const adminApp = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$admin$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["initializeAdminApp"])();
...
async function getAdminQuoteRequests(idToken) {
    try {
        ...
        const quoteRequests = quoteRequestsSnapshot.docs.map((doc)=>{
            ...
            const submittedDate = data.submittedDate?.toDate ? data.submittedDate.toDate().toISOString() : data.submittedDate;
            const rentalStartDate = data.rentalStartDate?.toDate ? data.rentalStartDate.toDate().toISOString() : data.rentalStartDate;
            const rentalEndDate = data.rentalEndDate?.toDate ? data.rentalEndDate.toDate().toISOString() : data.rentalEndDate;
            return {
                id: doc.id,
                ...data,
                submittedDate,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e8cadb11._.js.map