...
function ItemSelector({ item, form }) {
    ...
    const currentItem = fieldIndex !== -1 ? fields[fieldIndex] : null;
    const handleQuantityChange = (change)=>{
        ...
        if (newQuantity === 0) {
            ...
            if (fieldIndex === -1) {
                ...
                updatedItems[fieldIndex].quantity = newQuantity;
    ...
    const handleHirePurchaseChange = (type)=>{
        if (fieldIndex === -1) {
            append({
                id: item.id,
                name: item.name,
            ...
            updatedItems[fieldIndex].type = type;
            if (updatedItems[fieldIndex].quantity === 0) {
                updatedItems[fieldIndex].quantity = 1;
            }
            setValue('items', updatedItems, {
                shouldValidate: true
            });
    ...
    const hasHire = 'hirePrice' in item && item.hirePrice;
    const hasPurchase = 'purchasePrice' in item && item.purchasePrice;
            ...
            hasHire && hasPurchase ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$form$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["FormField"], {
                    ...
                    render: ()=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$radio$2d$group$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["RadioGroup"], {
                            ...
                            onValueChange: (value)=>handleHirePurchaseChange(value),
...
function QuoteForm() {
    ...
    async function onSubmit(values) {
        ...
        try {
            const selectedItems = values.items.map((item)=>`${item.name} (Qty: ${item.quantity}${item.type ? `, ${item.type}` : ''})`).join(', ');
...
//# sourceMappingURL=src_33d7e1e7._.js.map